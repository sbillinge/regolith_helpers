...
def create_parser():
    ...
    npr = subp.add_parser("npr", help="adds a new empty proposal review")#
    npr.add_argument("name", help="pi first name space last name in quotes",
                        default=None)
    npr.add_argument("type", help="nsf or doe", default=None)
    npr.add_argument("due_date", help="due date in form YYYY-MM-DD",
                        default=None)
    npr.add_argument("-q", "--requester",
                        help="Name of the Program officer requesting"
                        )
    npr.add_argument("-r", "--reviewer",
                        help="name of the reviewer.  Defaults to sbillinge")
    npr.add_argument("-s", "--status",
                        help="status, from [invited, accepted, declined, downloaded,"
                             "inprogress, submitted], default is accepted")
    npr.add_argument("-t", "--title",
...
"""
"""
from regolith_helpers.commands import INGEST_COLL_LU
